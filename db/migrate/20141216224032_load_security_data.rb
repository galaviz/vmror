class LoadSecurityData < ActiveRecord::Migration
  def up
	...
	Page.create(:description => "Usuarios", :command => "users", :order_by => 6, :menu_id => 2, :active => true)
	Page.create(:description => "Perfiles", :command => "profiles", :order_by => 7, :menu_id => 2, :active => true)
	Page.create(:description => "Páginas", :command => "pages", :order_by => 8, :menu_id => 2, :active => true)
	Page.create(:description => "Permisos", :command => "permissions", :order_by => 9, :menu_id => 2, :active => true)
